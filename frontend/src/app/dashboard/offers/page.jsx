    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div><label className={lbl}>Start Date</label><input type="datetime-local" className={inp} value={startDate ? startDate.slice(0, 16) : ""} onChange={e => setStartDate(e.target.value)} /></div>
          <div><label className={lbl}>End Date</label><input type="datetime-local" className={inp} value={endDate ? endDate.slice(0, 16) : ""} onChange={e => setEndDate(e.target.value)} /></div>
