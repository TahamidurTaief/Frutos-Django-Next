// 'use client'
// // src/app/checkout/_components/OrderSidebar.jsx

// import Image from 'next/image'

// export default function OrderSidebar({ items, subtotal, delivery, total, loading, onPlaceOrder }) {
//   return (
...
//                   <p className="font-bold text-sm truncate" style={{ color: '#151e13' }}>
//                     {item.name}
//                   </p>
//                   <p className="text-xs italic" style={{ fontFamily: '"Newsreader", Georgia, serif', color: '#5a6b63' }}>
//                     from {item.origin}
//                   </p>
...
'use client'
// src/app/checkout/_components/OrderSidebar.jsx
// Promo discount row যোগ করা হয়েছে
