...
// import { getDeliveryWindows } from '@/lib/api'
...
// // ── Fetch regular (consumer) user profile + addresses from cookie JWT ─────────
...
//     const addressData = addressRes.status  === 'fulfilled' && addressRes.value.ok
//       ? await addressRes.value.json()   : null
...
//   const [windowsResult, productsResult, regularData] = await Promise.allSettled([
//     getDeliveryWindows(),
//     getProducts(),
...
//             <a href="/shop"
//               className="text-[13px] font-bold text-[#151E13] border-b-2 border-[#00694C] pb-1 hover:text-[#00694C] transition-colors">
//               VIEW ALL PRODUCE
//             </a>
//           </div>
//         </div>
