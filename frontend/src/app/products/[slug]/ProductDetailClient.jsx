...
// //
// // Centralises all unit-selection logic so both the desktop and mobile
// // price displays stay in sync.
// //
// // Returns:
// //   unitOptions      – array of unit objects from the API (may be empty)
// //   hasUnits         – whether we have unit options at all
// //   selectedUnitId   – currently selected unit's id (or null when no units)
// //   selectedUnit     – the full selected unit object (or null)
// //   handleUnitChange – call with the option id (string) from onChange
// //   retailPrice      – effective retail price for the current selection
// //   wholesaleUnitPrice – wholesale price for the current unit (or null)
...
//   // Find the default unit (first is_default=true, then first item, then null)
...
//   // Wholesale price for this unit (unit-level first, then product-level)
...
//   if (!hasUnits) {
//     // No unit options defined — show a read-only label
//     return (
...
//   // ── Unit selection (the core of this feature) ──────────────────────────────
//   const {
//     unitOptions, hasUnits,
...
//   // Effective price shown to this user
//   const displayPrice      = wholesaleUnitPrice ?? retailPrice
//   const isWholesalePrice  = !!wholesaleUnitPrice
//   const baseRetailPrice   = Number(product.price)  // for card/strikethrough reference
...
//       }
//     }
//     // Pass the selected unit label + effective price into cart
//     addItem(
...
//                   {/* Unit dropdown — dynamic from admin */}
//                   <div>
...
//                 {/* Estimated total — updates with both unit and qty */}
