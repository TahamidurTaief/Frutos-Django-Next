...
//           A minimum of <strong style={{ color:'white' }}>{product.minWholesaleQty} {product.wholesaleUnit || 'units'}</strong> is required to unlock the wholesale price of <strong style={{ color:'#6EE7B7' }}>{'€'}{price}</strong>.
//         </p>
//       </div>
...
//             {/* Right badge */}
//             {onSale && !isWholesalePrice && (
//               <span className="absolute top-2 right-2 text-[10px] font-bold tracking-widest px-2.5 py-1 rounded-full bg-[#151E13] text-white">
//                 SALE
//               </span>
//             )}
//             {isWholesalePrice && (
//               <span
//                 className="absolute top-2 right-2 text-[10px] font-bold tracking-widest px-2 py-1 rounded-full text-white"
...
//               {/* Origin — fixed max width, always right-aligned */}
//               {origin && (
...
//                   </span>
//                   <span
//                     className="font-serif italic text-[10px] md:text-[11px] text-gray-400 leading-tight block"
//                     style={{
//                       overflow: 'hidden',
//                       display: '-webkit-box',
//                       WebkitLineClamp: 2,
...
//             {/* Unit */}
//             {unit && (
//               <p className="text-[11px] md:text-[12px] text-gray-400 mb-2 leading-tight">
//                 {unit}
//               </p>
//             )}
...
//                 {/* <span onClick={(e) => e.preventDefault()} className="w-full md:hidden">
//                   <AddToCartButton
//                     product={product}
//                     inStock={inStock}
//                     isWholesale={isApprovedWholesale}
