...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        standard_method.shipping_categories.add(general_category, electronics_category)
        express_method.shipping_categories.add(general_category, electronics_category)
        economy_method.shipping_categories.add(general_category)
